...
- **MSVCOD: A Large-Scale Multi-Scene Dataset for Video Camouflage Object Detection** — Gao, Shuyong, Feng, Yu'ang, Wang, Qishan, Hong, Lingyi, Zhou, Xinyu, Fei, Liu, Wang, Yan, Zhang, Wenqiang, *arXiv* (2025). Introduces MSVCOD; dataset/code release is stated as future work in the arXiv paper.  
  `preprint` · `metadata-only` · `paper` · dataset · [source](https://arxiv.org/abs/2502.13859)
