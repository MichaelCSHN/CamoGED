...
| CHAMELEON | `image-cod` | `rgb` | 76 images | test-only |  |  |  | `` |
| CoCOD8K | `collaborative-cod` | `rgb` | 8,528 images | train/test | 2023 | [link](https://github.com/zc199823/BBNet--CoCOD) |  | `zhang2023collaborative` |
| COD10K | `image-cod` | `rgb` | 5,066 camouflaged (~10K total) | 3,040 train / 2,026 test; 78 sub-classes | 2020 | [link](https://dengpingfan.github.io/pages/COD.html) |  | `fan2020sinet` |
| MCOD | `image-cod` | `multispectral` |  | benchmark | 2025 | [link](https://github.com/yl2900260-bit/MCOD) | CC BY-NC-ND 4.0 | `mcod2025` |
| MHCD2022 | `image-cod` | `rgb` | 3,000 images | 5 categories | 2022 |  |  | `` |
| MM-CamObj | `dataset` | `multimodal` |  | QA/detection | 2024 | [link](https://github.com/JCruan519/MM-CamObj) |  | `mmcamobj2024` |
| MoCA-Mask | `video-cod` | `video` | 87 sequences; 22,939 frames | train/test | 2022 | [link](https://xueliancheng.github.io/SLT-Net-project/) |  | `cheng2022implicit` |
